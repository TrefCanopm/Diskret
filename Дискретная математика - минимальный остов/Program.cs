...
namespace Дискретная_математика___минимальный_остов
{
    internal class Program
    {
        ...
        {
            StreamReader file = new StreamReader("D:\\Мои проекты Vethyal studia\\Дискретная математика - минимальный остов\\Matrix.txt");
        ...
        static void Main()
        {
            ...
            mas[0] = "!) Ввод матрицы";
            mas[1] = "2) Построение минимального остова";
            mas[2] = "3) Закончить работу";
